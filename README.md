...
## Project Structure
    ...
    ├── mobilemultifile_dev_22720  # Django project configurations
...
1. Clone this repo and `cd mobilemultifile_dev_22720`
...
2. Clone this repo and `cd mobilemultifile_dev_22720`
